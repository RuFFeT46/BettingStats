...
import com.betting.entity.Money;
...
public class Team {
    ...
    private int teamId;
    private String name;
    private List<Bet> teamBets;
    private List<Game> teamGames;

    public Team(String name) {
        this.teamId = Database.getInstance().getTeams().size() + 1;
        this.name = name;
        this.teamBets = new ArrayList<>();
        this.teamGames = new ArrayList<>();
        Wrapper.getInstance().getTeams().add(new TeamWrapper(this));
    }

    public Team(TeamWrapper teamWrapper){
        this.teamId = teamWrapper.getTeamId();
        this.name = teamWrapper.getName();
        this.teamGames = new ArrayList<>();
        this.teamBets = new ArrayList<>();
    }
    ...
    public List<Bet> getTeamBets() {
        return teamBets;
    }

    public void setTeamBets(List<Bet> teamBets) {
